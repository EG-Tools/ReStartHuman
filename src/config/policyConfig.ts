export const policyConfig = {
  ...
  policyStatus:
    '정책 기준일은 2026년 3월 27일입니다. 일반계좌 배당 원천징수, ISA 절세, 금융소득과 다른 종합소득의 합산 비교세액 공개 기준을 반영했고, 건강보험과 종합소득세는 공개 기준을 참고한 단순 추정치입니다.',
  ...
  isa: {
    ...
    excessTaxRate: 0.099,
    note:
      'ISA 자산 입력액을 납입원금 대용치로 보고 연 배당 인출액만큼 원금 인출 한도를 차감합니다. 한도가 소진되는 해에 일반형 200만원, 서민형 400만원 비과세와 초과분 9.9% 분리과세를 한 번 적용해 정산합니다. 별도 손실은 입력받지 않아 실제 해지 세액과 다를 수 있습니다.',
  },
  healthInsurance: {
    ...
    approximationNotice:
      '직장가입자 7.19% 보험료율, 보수월액 본인 50%와 보수 외 소득월액 본인 전액 부담, 보수 외 소득 2,000만원 기준, 지역가입자 재산 기본공제 1억원, 피부양자 재산세 과표 5.4억원·9억원 구간을 참고한 단순 추정 모델입니다. 직장 근로 기간 종료 후에는 1인은 지역가입자, 부부는 부부 모두 지역가입자로 자동 전환합니다.',
  },
  holdingTax: {
    referenceDate: '2026-03-20',
  ...
  comprehensiveIncomeTax: {
    ...
    note:
      '금융소득은 인별로 연 2,000만원 초과 여부를 판정하고, 초과 시 다른 종합소득 과세표준과 합산한 비교세액을 적용합니다. 추정 종합소득세는 근로소득공제, 국민연금 연금소득공제, 기타소득 필요경비 60%와 소득금액 300만원 기준, 본인 기본공제 150만원을 단순 반영합니다.',
    brackets: [
      {
        upperBound: 14_000_000,
        rate: 0.06,
