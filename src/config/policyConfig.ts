export const policyConfig = {
  ...
  policyStatus:
    '정책 기준일은 2026년 3월 20일입니다. 일반계좌 배당 원천징수, ISA 특례, 금융소득 종합과세는 정부 공개 기준 구조를 반영했습니다. 자가 주택세는 지방세법상 재산세 구조를 참고했고, 건강보험료는 NHIS 공개 구조를 참고한 단순화 추정치이므로 실제 고지액과 다를 수 있습니다.',
  ...
  holdingTax: {
    ...
    note:
      '재산세는 지방세법상 본세, 도시지역분, 지방교육세 구조를 반영했습니다. 2026년 3월 20일 기준 1세대 1주택 공정시장가액비율의 2026 연장 발표는 확인하지 못해, 최신 확인 가능한 2025 완화 비율 43%·44%·45%를 기본 적용했습니다. 이는 최신 공식 자료를 바탕으로 한 추정입니다. 종합부동산세와 세부담상한은 아직 제외했습니다.',
    standardRates: [
      {
